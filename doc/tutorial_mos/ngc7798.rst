...
.. note::
   ...
   It is assumed that the reader has already followed the previous tutorials
   :ref:`simple_example` and :ref:`mos_example`. Some of the concepts already
   introduced there are not going to be repeated here with the same level of
   detail.

In this case we are going to reduce simple spectroscopic observations obtained
in the central region of the HII galaxy NGC7798 using the J, H and K grisms. In
this case the target was observed with all the EMIR slitlets aligned,
simulating a single longslit.
...
``STARE_SPECTRA_WAVE``). The first lines of the associated observation result
``00_stare_hd209290.yaml`` are:
...
::
   ...
   (py36) $ numina-imath obsid5278_results/stare.fits - obsid5275_results/stare.fits grismJ_hd209290_A-B.fits
   (py36) $ numina-imath obsid5269_results/stare.fits - obsid5272_results/stare.fits grismH_hd209290_A-B.fits
   (py36) $ numina-imath obsid5266_results/stare.fits - obsid5263_results/stare.fits grismK_hd209290_A-B.fits
...
::
   ...
   (py36) $ numina-imath obsid5178_results/stare.fits - obsid5189_results/stare.fits grismJ_ngc7798_A-B.fits
   (py36) $ numina-imath obsid5211_results/stare.fits - obsid5200_results/stare.fits grismH_ngc7798_A-B.fits
   (py36) $ numina-imath obsid5222_results/stare.fits - obsid5233_results/stare.fits grismK_ngc7798_A-B.fits
