...
This tutorial provides a short introduction to the rectification and wavelength
calibration of EMIR spectroscopic images using PyEmir. In any case, it is
expected to be an easy introduction to the use of numina and PyEmir. 
...
.. warning::
   ...
   are not yet covered sufficient detail. More detailed instructions will be
