...
::
   ...
   (emir) $ dfits data/0001877*.fits | fitsort imgobbl nimgobbl object exptime readmode
   FILE                                          	IMGOBBL	NIMGOBBL	OBJECT  	EXPTIME 	READMODE
   data/0001877553-20181217-EMIR-STARE_IMAGE.fits	1      	7       	TEST    	29.99926	RAMP    	
   data/0001877559-20181217-EMIR-STARE_IMAGE.fits	2      	7       	TEST    	29.99926	RAMP    	
   data/0001877565-20181217-EMIR-STARE_IMAGE.fits	3      	7       	TEST    	29.99926	RAMP    	
   data/0001877571-20181217-EMIR-STARE_IMAGE.fits	4      	7       	TEST    	29.99926	RAMP    	
   data/0001877577-20181217-EMIR-STARE_IMAGE.fits	5      	7       	TEST    	29.99926	RAMP    	
   data/0001877583-20181217-EMIR-STARE_IMAGE.fits	6      	7       	TEST    	29.99926	RAMP    	
   data/0001877589-20181217-EMIR-STARE_IMAGE.fits	7      	7       	TEST    	29.99926	RAMP    	
   data/0001877595-20181217-EMIR-STARE_IMAGE.fits	1      	7       	TEST    	29.99926	RAMP    	
   data/0001877601-20181217-EMIR-STARE_IMAGE.fits	2      	7       	TEST    	29.99926	RAMP    	
   data/0001877607-20181217-EMIR-STARE_IMAGE.fits	3      	7       	TEST    	29.99926	RAMP    	
   data/0001877613-20181217-EMIR-STARE_IMAGE.fits	4      	7       	TEST    	29.99926	RAMP    	
   data/0001877619-20181217-EMIR-STARE_IMAGE.fits	5      	7       	TEST    	29.99926	RAMP    	
   data/0001877625-20181217-EMIR-STARE_IMAGE.fits	6      	7       	TEST    	29.99926	RAMP    	
   data/0001877631-20181217-EMIR-STARE_IMAGE.fits	7      	7       	TEST    	29.99926	RAMP    

Note that the keyword ``NIMGOBBL`` provides the total number of images in each
dithering pattern (7 in this case), whereas ``IMGOBBL`` indicates the
sequential number within each pattern.
