...
class MasterBadPixelMaskRequirement(Requirement):
    def __init__(self, optional=True):
        super(MasterBadPixelMaskRequirement, self).__init__(
            prods.MasterBadPixelMask, "Master bad pixel mask", optional=optional
        )
...
class MasterIntensityFlatFieldRequirement(Requirement):
    def __init__(self):
        super(MasterIntensityFlatFieldRequirement, self).__init__(
            prods.MasterIntensityFlat, "Master intensity flatfield"
        )
...
class RefinedBoundaryModelParamRequirement(Requirement):
    def __init__(self):
        super(RefinedBoundaryModelParamRequirement, self).__init__(
            prods.RefinedBoundaryModelParam, "Refined boundary model"
        )


class MasterRectWaveRequirement(Requirement):
    def __init__(self, optional=False):
        super(MasterRectWaveRequirement, self).__init__(
            prods.MasterRectWave,
            "Master rectification+wavelength library",
            optional=optional,
        )
...
class RectWaveCoeffRequirement(Requirement):
    def __init__(self, optional=False):
        super(RectWaveCoeffRequirement, self).__init__(
            prods.RectWaveCoeff,
            "Rectification+wavelength calibration coefficients",
            optional=optional,
        )
...
class ListOfRectWaveCoeffRequirement(Requirement):
    def __init__(self, optional=False):
        super(ListOfRectWaveCoeffRequirement, self).__init__(
            ListOfType(prods.RectWaveCoeff),
...
class SpectralSkyRequirement(Requirement):
    def __init__(self, optional=False):
        super(SpectralSkyRequirement, self).__init__(
            prods.SkySpectrum, "Sky spectrum for subtraction", optional=optional
        )
...
class SkyImageSepTime_Requirement(Parameter):
    def __init__(self):
        super(SkyImageSepTime_Requirement, self).__init__(
            10.0, "Maximum time interval between target and sky images [minutes]"
        )
