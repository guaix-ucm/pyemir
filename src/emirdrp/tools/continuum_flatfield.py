...
def main(args=None):
    ...
    parser.add_argument(
        "--nwindow_median",
        help="Window size to smooth median spectrum in the " "spectral direction",
        type=int,
    )
    parser.add_argument(
        "--outfile",
    ...
    # optional arguments
    parser.add_argument(
        "--delta_global_integer_offset_x_pix",
        help="Delta global integer offset in the X direction " "(default=0)",
        default=0,
        type=int,
    )
    parser.add_argument(
        "--delta_global_integer_offset_y_pix",
        help="Delta global integer offset in the Y direction " "(default=0)",
        default=0,
        type=int,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--ignore_DTUconf",
        help="Ignore DTU configurations differences between " "model and input image",
        action="store_true",
    )
    parser.add_argument(
        "--debugplot",
    ...
    rectwv_coeff.global_integer_offset_x_pix += args.delta_global_integer_offset_x_pix
    rectwv_coeff.global_integer_offset_y_pix += args.delta_global_integer_offset_y_pix
    ...
    if True:
        ...
        ximplotxy(
            np.arange(1, EMIR_NBARS + 1),
            ycut_median,
            "ro",
            title="median value of each spectrum",
            debugplot=12,
        )
        ximshow(image2d_sp_median_eq, title="sp_median_eq", debugplot=12)

    csu_conf_fitsfile.display_pseudo_longslits(list_valid_slitlets=list_valid_islitlets)
