...
def main(args=None):
    ...
    image2d_rectified_wv_initial = np.zeros((EMIR_NAXIS2, naxis1_enlarged))
    image2d_rectified_wv_refined = np.zeros((EMIR_NAXIS2, naxis1_enlarged))
    image2d_rectified_wv_modeled = np.zeros((EMIR_NAXIS2, naxis1_enlarged))
